...
function QuestionsTab(props) {
  ...
  function saveQuestions() {
    console.log("saving questions initiated");
    console.log("sform data",formData);
    var data = {
      formId: formData._id,
      name: formData.name,
    ...
    axios.put("/editform", data, { headers: headers }).then((response) => {
      ...
      <div>
        <div style={{ marginBottom: "15px" }}>
          <div style={{ width: "100%", marginBottom: "-7px" }}>
            <DragIndicatorIcon
              style={{ transform: "rotate(-90deg)", color: "#ff8a80" }}
              fontSize="small"
            />
          </div>
