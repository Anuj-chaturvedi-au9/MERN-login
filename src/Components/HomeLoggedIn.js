  ...
  const createForm = () => {
    ...
    if (data.name !== "") {
      axios
        ...
        .then((response) => {
          history.push("/form/" + response.data._id);
        });
    }
  };
      ...
      <AppBar position="static" style={{ backgroundColor: "#ff8a80" }}>
        <Toolbar>
          ...
          <div className={classes.sectionDesktop}>
            ...
            >
              <AddIcon />
              <p style={{ fontSize: "15px" }}>Create Form</p>
            </IconButton>
            ...
            <Link to="/allforms" style={{ color: "white" }}>
              <IconButton aria-label="user profile" color="inherit">
                <PersonIcon />

                <p style={{ fontSize: "15px" }}>All Forms</p>
              </IconButton>
            </Link>
